...
public class ForgotPasswordController {
    ...
    public void sendEmail(String recipientEmail, String link)
        ...
        String subject = "Aqui� esta el enlace para restablecer su contrase�a";
        String content = "<p>Hola,</p>"
                + "<p>Ha solicitado restablecer su contrase�a.</p>"
                + "<p>Haga clic en el enlace de abajo para cambiar su contrase�a:</p>"
                + "<p><a href=\"" + link + "\">Cambiar mi contrase�a</a></p>"
                + "<br>"
                + "<p>Ignore este correo electronico si recuerda su contrase�a, "
