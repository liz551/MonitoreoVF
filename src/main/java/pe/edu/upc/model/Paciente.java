...
private static final long serialVersionUID = 1L;
	...
	@NotBlank(message="No puede estar en blanco")
	@NotEmpty(message="No puede estar vacio")
	@Pattern(regexp="[0-9]{8,12}", message="DNI: Solo se permite 7 d�gitos num�ricos, Otros: Solo se permite 12 d�gitos num�ricos ")
	@Column(name = "nroDocumento", length = 12, nullable = false)
	private String nroDocumento;
	@NotBlank(message="No puede estar en blanco")
	@NotEmpty(message="No puede estar vacio")
	@Column(name = "celular", nullable = false)
	@Pattern(regexp="[0-9]{9}", message="Solo se permite 9 valores n�mericos ")
